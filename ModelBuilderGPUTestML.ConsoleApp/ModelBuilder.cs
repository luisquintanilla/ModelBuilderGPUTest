...
using ModelBuilderGPUTestML.Model;
using Microsoft.ML.Vision;

namespace ModelBuilderGPUTestML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\luquinta.REDMOND\AppData\Local\Temp\020b7820-ace6-405f-857e-ed7fd324c224.tsv";
        private static string MODEL_FILEPATH = @"../../../../ModelBuilderGPUTestML.Model/MLModel.zip";
